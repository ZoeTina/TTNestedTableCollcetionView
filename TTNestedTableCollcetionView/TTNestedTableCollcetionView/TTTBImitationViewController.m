...
@interface TTTBImitationViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation TTTBImitationViewController{
...
- (void)setHeadImage{
    ...
    headImage.image = [UIImage imageNamed:@"base_image_tu64"];
    [self.view addSubview:headImage];
    self.headImageView = headImage;
}

- (void)setNav{
    UIView *naviView = [[UIView alloc]initWithFrame:CGRectMake(0, 0, kScreenWidth, kNavBarHeight)];
    ...
    UIImage *reftImage = [[UIImage imageNamed:@"nav_back_copy"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
    ...
    UIImage *rightImage = [[UIImage imageNamed:@"mine_nav_share"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
...
- (void)setTopView{
    ...
    tipLine.frame = CGRectMake(5, 38, kScreenWidth / 4.0 - 10, 2);
...
- (void)setTableView{
    UITableView *tableView = [[UITableView alloc]initWithFrame:CGRectMake(0, kNavBarHeight + kTopViewHeight, kScreenWidth, kScreenHeight - kNavBarHeight - kTopViewHeight) style:UITableViewStyleGrouped];
...
- (CGFloat)tableView:(UITableView *)tableView heightForHeaderInSection:(NSInteger)section{
    if (section == 0) {
        return headViewHeight - kNavBarHeight - kTopViewHeight;
    }else{
        return 40;
    }
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.textLabel.text = [NSString stringWithFormat:@"商品%zd 价钱-- %@",indexPath.row,self.contentStr];
    return cell;
}
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView{
    ...
    [UIView animateWithDuration:0.4 animations:^{
        self.tipLine.frame = CGRectMake(5 + (indexPath.section * (kScreenWidth / 4.0)), 38, kScreenWidth / 4.0 - 10, 2);
    }];
